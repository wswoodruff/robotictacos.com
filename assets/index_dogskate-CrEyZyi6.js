import"./modulepreload-polyfill-B5Qt9EMX.js";import{O as f}from"./OutlinePass-B-xMzC4J.js";import{C as u,F as g,b as d,c as l,S as p,d as v,e as h,a as w,G as C}from"./GLTFLoader-CsBpgCdH.js";import{I as b,s as P,a as y,c as S,r as x,o as _,b as k,d as F,e as A,f as E}from"./ImprovedNoise-BVOZRgZT.js";import{C as m}from"./tiles-CyD6-eWE.js";import{E as O,R as T,A as U,S as D,D as R,O as B}from"./AfterimagePass-DJPqY81_.js";const e={animationPool:new m,gameTime:new u,viewFrustum:new g,usePostProcessing:!1,camera:null,orbitControl:null,mouseDelta:new d,firstColor:new l().setHex(16735419),seconistColor:new l().setHex(16774236),noise1:new b,modelsCache:new m};async function G(){P(e,{color:16747183}),y(e,e.scene),S(e,{position:[0,0,40]}),e.camera.position.fromArray([4.537213541040106,1.0733651621338063,10.88682595412294]),e.camera.rotation.fromArray([-.26366054378468406,.5392574568225623,.13773874353647544,"XYZ"]),x(e,{antialias:!0}),e.renderer.autoClear=!1,_(e,e.camera,e.renderer),e.orbitControl.enableDamping=!0,e.orbitControl.dampingFactor=.12;const n=document.getElementById("threedee1").getBoundingClientRect();e.orthographicCamera=new k(e,{rect:n,near:1,far:1e3});{e.wallpaperScene=new p;const a=new v({uniforms:{u_time:{value:0}},vertexShader:`
        varying vec2 vUv;
