import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                    */import{C as c,F as l,V as m,a as n,S as u,b as f,P as d,M as v}from"./GLTFLoader-wlXMjBjz.js";import{I as p,s as g,c as b,r as C,o as h,b as w,g as x,d as y,e as P,f as S}from"./ImprovedNoise-DKX4s_KG.js";import{C as t}from"./tiles-DzyDbYKX.js";const e={animationPool:new t,gameTime:new c,viewFrustum:new l,usePostProcessing:!1,camera:null,orbitControl:null,mouseDelta:new m,firstColor:new n().setHex(16735419),seconistColor:new n().setHex(16774236),noise1:new p,tacosCars:new t};async function U(){g(e,{color:16735419}),b(e,{position:[0,0,40]}),C(e),e.renderer.autoClear=!1,h(e,e.camera,e.renderer);const s=document.getElementById("threedee1").getBoundingClientRect();e.orthographicCamera=new w(e,{rect:s,near:1,far:1e3});{e.wallpaperScene=new u;const a=new f({uniforms:{u_time:{value:0}},vertexShader:`
        varying vec2 vUv;
